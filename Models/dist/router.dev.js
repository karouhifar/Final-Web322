...
var router = express.Router(); // Setting our min-app router

var controller = require("./controllers/controller");

var MulterData = require("../Multer");

var DataValid = require("./.DataValid"); // setup another route to listen on /about
//--------------------------------------------------------------
